"""
Django settings for c3_nexus project.
...
SECRET_KEY = 'django-insecure-&&b=!z+c12=1@_s-baw25$6#($je7zdk()s#cj6rd81iqi*x^e'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',  # Ensure this is inside the list, not added separately
    'dealership',
    'inventory',
    'warranty',
    'users',
...
WSGI_APPLICATION = 'c3_nexus.wsgi.application'
